...
import com.lht.justdraw.justdraw.JustView;
...
public class JustCanvas extends JustV8Object {
    ...
    protected void initV8Object() {
        ...
        mObject.add("x", 0);
        mObject.add("y", 0);
        mObject.add("width", ScreenUtil.screenWidth);
        mObject.add("height", ScreenUtil.screenHeight - ScreenUtil.navbarheight - ScreenUtil.statusbarheight);
    }
